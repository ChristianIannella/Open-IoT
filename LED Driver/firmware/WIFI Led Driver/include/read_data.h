...
void read_data()
{
  ...
  topic_string = (mqtt_user + "/" + mqtt_password + "/wifileddriver/" + device_name);
  cb_topic_string = (mqtt_user + "/" + mqtt_password + "/wifileddrivercb/" + device_name);
